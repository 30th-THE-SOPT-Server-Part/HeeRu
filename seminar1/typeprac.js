...
// 배열 타입 표현 방법 2가지
var agesMethod1 = [1, 2, 3, 4, 5];
var agesMethod2 = [23, 23, 12];
var strArray = ["hi", "hello"];
var strArray2 = ["hi", "hello"];
// Object vs object
...
var yourName = '채리지아';
var yourNameLength = yourName.length; // 스위프트의 타입캐스팅임
console.log(yourName, yourNameLength);
// 2. angle-bracket
var serverName = '짱정아'; // any는 마법마냥 아무 타입이나 가능
var serverNameLength = serverName.length; // 형 변환 -> 스위프트에서 String()으로 감싸주는 식임.
